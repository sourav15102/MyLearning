A subnet is a logical subdivision of an IP network. It is a group of IP addresses that are part of a larger network, but are treated as a separate network segment.
